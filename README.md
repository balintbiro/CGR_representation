...
python ./cgr_cnn.py --logfile cnn.log --seqfile data/deeploc_clean.csv --fcgrfile data/random_encoding_0865_35.csv --outfile data/cnn_res_iter.csv --sf 0.856 --res 35
```
